...
class VolteLoad(Resource):
    ...
    def post():
        ...
        uscc_eng_parser.add_argument('host', required=True, location='form')
        uscc_eng_parser.add_argument('database', required=True, location='form')
        uscc_eng_parser.add_argument('port', required=True, location='form')
        uscc_eng_parser.add_argument('user', required=True, location='form')
        uscc_eng_parser.add_argument('password', required=True, location='form')
        uscc_eng_parser.add_argument('sql_cmd', required=True, location='form')
        uscc_eng_parser.add_argument('sql_params', location='form')
